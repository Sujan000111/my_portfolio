  ...
  const projects: Record<string, Project[]> = {
    fullstack: [
      ...
      /*{
        title: "Namma Krishi",
        url: "#",
        imageUrl: `https://i.imgur.com/your-namma-krishi-image.jpg`,
        github: "#",
        techStack: ["IoT", "AI", "Voice Support", "Remote Control"],
      },
      {
        title: "Deepfake Detection",
        url: "#",
        imageUrl: `https://i.imgur.com/your-deepfake-image.jpg`,
        github: "#",
        techStack: ["Python", "ResNeXt", "LSTM"],
      },
      {
        title: "Travello Website",
        url: "#",
        imageUrl: `https://i.imgur.com/your-travello-image.jpg`,
        github: "#",
      ...
      },
      {
        ...
        url: "#",
        imageUrl: `https://i.imgur.com/your-hospital-image.jpg`,
        github: "#",
        techStack: ["HTML", "CSS", "JavaScript"],
      },
      {
        title: "Karnataka Tourism Ride App",
        url: "#",
        imageUrl: `Coming soon`,
        github: "#",
        techStack: ["Django", "Google Maps API"],
      },*/
    ],
    mini: [],
    landing: [],
    ...
    <section id="projects" className="py-20 bg-black text-white w-full">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <div className="mt-14 text-center">
          <a
            href="https://github.com/Sujan000111"
            target="_blank"
            rel="noopener noreferrer"
