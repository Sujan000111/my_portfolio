    ...
    >
      ...
      <section className="flex flex-col items-center md:w-1/2 text-center space-y-6 md:space-y-8">
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://x.com/nimma_sujan" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
        ...
        >
          <Link
            href="mailto:sujanofficialsujan@gmail.com"
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://github.com/Sujan000111" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://www.linkedin.com/in/sujan0011/" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
